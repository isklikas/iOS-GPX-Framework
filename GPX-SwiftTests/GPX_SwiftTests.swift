...
import XCTest
@testable import GPX_Swift

class GPX_SwiftTests: XCTestCase, GPXParsing {
    
    func parser(_ parser: GPX_Swift.GPXXMLParser, didCompleteParsing rootXMLElement: GPX_Swift.GPXXMLElement) {
    ...
    func parser(_ parser: GPX_Swift.GPXXMLParser, didFailParsingWithError error: Error) {
    ...
    func testExample() throws {
        ...
        let path = bundle.path(forResource: "mystic_basin_trail", ofType: "gpx")!
